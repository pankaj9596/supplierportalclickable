		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comspmsuppilerportal-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comspmsuppilerportal-display": {
								"semanticObject": "comspmsuppilerportal",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.spm.suppilerportal",
									"url": sap.ui.require.toUrl("com/spm/suppilerportal")
								}
							}
						}
					}
